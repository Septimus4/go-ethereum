...
const (
	...
	DefaultElasticityMultiplier     = 3          // Bounds the maximum gas limit an EIP-1559 block may have.
	DefaultElasticityDivisor        = 4          // Bounds the minimum gas limit an EIP-1559 block may have.
