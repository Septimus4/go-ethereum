...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	engine, err := ethconfig.CreateConsensusEngine(chainConfig, chainDb, config.HeaderValidatorWorkerCount)
	if err != nil {
		return nil, err
	}
	...
	eth.blockchain, err = core.NewBlockChain(chainDb, cacheConfig, config.Genesis, &overrides, eth.engine, vmConfig, &config.TransactionHistory, config.HeaderValidatorWorkerCount, config.BlockValidatorWorkerCount)
	if err != nil {
		return nil, err
	}
